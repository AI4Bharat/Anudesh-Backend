...
class AnalyticsViewSet(viewsets.ViewSet):
    ...
    def get_user_analytics(self, request):
        ...
        try:
            ...
            project_type = request.data.get("project_type") or request.data.get("project_types")
        ...
        is_textual_project = not any(pt in get_audio_project_types() for pt in project_type)
        ...
        has_textual_projects = any(pt not in get_audio_project_types() for pt in project_type)
